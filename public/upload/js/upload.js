(function( $ ){
    ...
    $(function() {	
        ...
        uploader = WebUploader.create({
            ...
            server:up_server,
            runtimeOrder:"html5",
            accept:{title: '文件类型',extensions:'gif,jpg,jpeg,png,webp,zip,rar,7z,gz,tar,mp4,doc,docx,xls,xlsx,ppt,pptx,apk,iso,pdf,ico,mp3,m4a',mimeTypes: 'image/gif,image/jpeg,image/png,image/webp,video/mp4,application/zip,application/x-rar-compressed,application/x-7z-compressed,application/gzip,application/x-tar,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.presentation,application/vnd.android.package-archive,application/octet-stream,application/pdf,image/x-icon,audio/mpeg,audio/mp4'},
			compress:false,
			resize:false,
